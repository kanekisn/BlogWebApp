...
<div class = "container">
    <h3 class = "mt-5 mb-4 text-white">Login</h3>

    <form method="post">
        <div class="mb-3 row d-flex justify-content-center">
            <%if(request.getParameter("error") != null && request.getParameter("error").equals("invalid")){%>
                <p class="text-danger mb-3">You entered wrong data. Try again</p>
            <%}%>
        ...
        <div class= "d-flex justify-content-center">
            <button type="submit" class="btn btn-outline-secondary mt-5">Login</button>
        </div>
    </form>
    <div class= "d-flex justify-content-center">
        <p class = "text-white mt-3">Don't have an account? <a style ="text-decoration: none; color:deepskyblue" href="${pageContext.request.contextPath}/registration">Click here to create new one</a></p>
    </div>
</div>
<div class="container">
