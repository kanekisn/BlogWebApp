...
<div class = "container">
    <h3 class = "mt-5 mb-4 text-white">Update Article</h3>

    <form method="post">
        <%ArticleEntity entity = (ArticleEntity) request.getAttribute("article");%>
        <div class="mb-3 text-white">
            <label for="exampleFormControlInput1" class="form-label">Title</label>
            <input name = "title" value="<%=entity.getTitle()%>" type="text" class="form-control bg-dark text-white" id="exampleFormControlInput1" placeholder="test">
        </div>
        <div class="mb-3 text-white">
            <label for="exampleFormControlTextarea1" class="form-label">Content</label>
            <textarea name = "content" class="form-control bg-dark text-white" id="exampleFormControlTextarea1" rows="3"><%=entity.getContent()%></textarea>
        </div>
        <button name = "slug" value = "<%=entity.getSlug()%>" type="submit" class="btn btn-outline-secondary mt-3">Update</button>
    </form>
</div>
<div class="container">
